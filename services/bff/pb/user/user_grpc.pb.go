...
const (
	UserService_GetUserDetails_FullMethodName   = "/pb.UserService/GetUserDetails"
	UserService_GetUsers_FullMethodName         = "/pb.UserService/GetUsers"
	UserService_CreateUpdateUser_FullMethodName = "/pb.UserService/CreateUpdateUser"
)
...
func (c *userServiceClient) CreateUpdateUser(ctx context.Context, in *CreateUpdateUserRequest, opts ...grpc.CallOption) (*CreateUpdateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_CreateUpdateUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateUpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_CreateUpdateUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
